              ...
              <div className="p-6 rounded-2xl bg-white/60 dark:bg-gray-900/40 backdrop-blur-sm border border-gray-200/50 dark:border-gray-800/50">
                ...
                <div className="flex gap-3">
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="w-10 h-10 flex items-center justify-center rounded-xl bg-gray-100 dark:bg-gray-800 hover:bg-gradient-to-br hover:from-amber-400 hover:to-orange-500 text-gray-600 dark:text-gray-400 hover:dark:text-white hover:text-white transition-all duration-300"
                  >
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="w-10 h-10 flex items-center justify-center rounded-xl bg-gray-100 dark:bg-gray-800 hover:bg-gradient-to-br hover:from-pink-400 hover:to-purple-500 text-gray-600 dark:text-gray-400 hover:dark:text-white hover:text-white transition-all duration-300"
                  >
                    <svg className="w-4 h-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" fill="currentColor">
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="w-10 h-10 flex items-center justify-center rounded-xl bg-gray-100 dark:bg-gray-800 hover:bg-gradient-to-br hover:from-red-400 hover:to-red-600 text-gray-600 dark:text-gray-400 hover:dark:text-white hover:text-white transition-all duration-300"
                  >
