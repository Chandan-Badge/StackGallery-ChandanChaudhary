        ...
        <main className="relative z-10 w-full max-w-6xl mx-auto px-4 sm:px-6 pt-28 sm:pt-40 pb-12">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 lg:gap-12">
            ...
            <div className="lg:col-span-2 space-y-6">
              {/* Email Card */}
              <div className="group p-6 rounded-2xl bg-white/60 dark:bg-gray-900/40 backdrop-blur-sm border border-gray-200/50 dark:border-gray-800/50 hover:border-amber-300/50 dark:hover:border-yellow-500/30 transition-all duration-300 shadow-md hover:shadow-lg dark:hover:shadow-amber-500/10">
              ...
              {/* Social Links */}
              <div className="p-6 rounded-2xl bg-white/60 dark:bg-gray-900/40 backdrop-blur-sm border border-gray-200/50 dark:border-gray-800/50 shadow-md">
            ...
            <div className="lg:col-span-3">
              <form
                ...
                className="p-6 sm:p-8 rounded-2xl bg-white/70 dark:bg-gray-900/50 backdrop-blur-sm border border-gray-200/50 dark:border-gray-800/50 shadow-md"
              >
