...
const ACCENT = 'text-gray-800 dark:text-[#fff]';
...
const nextProjects = [
  {
    ...
    img: assets.courseProject,
    title: 'Physics Course',
    subtitle: 'Physics Students',
      ...
      <main className='px-4 sm:px-8'>
        ...
        <div className='relative px-3 sm:px-6 lg:px-12 py-4 w-full h-max bg-white/80 dark:bg-[#111] backdrop-blur-none flex flex-col gap-2 rounded-lg'>
          ...
          <div className='flex items-center gap-2 md:gap-3'>
            <p className={`text-xl md:text-2xl ${ACCENT} font-bold pl-2 sm:pl-0`}>Next.js Projects</p>
            <svg className='w-6 md:w-[30px]' viewBox="0 0 256 256" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" preserveAspectRatio="xMidYMid">
              <g>
