          ...
          <div className="flex flex-col items-start md:items-end">
            ...
            <div className="flex flex-wrap gap-3 mb-4">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="group w-10 h-10 flex items-center justify-center rounded-full bg-gray-100 hover:bg-gray-300 dark:bg-gray-800 hover:dark:bg-gray-600/80 text-gray-600 dark:text-gray-400 transition-all duration-300 hover:shadow-lg"
              >
              ...
              <a
                ...
                className="group w-10 h-10 flex items-center justify-center rounded-full bg-gray-100 hover:bg-gray-300 dark:bg-gray-800 hover:dark:bg-gray-600/80 text-gray-600 dark:text-gray-400 transition-all duration-300 hover:shadow-lg"
              >
                <svg className="w-4 h-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512">
              ...
              <a
                ...
                className="group w-10 h-10 flex items-center justify-center rounded-full bg-gray-100 hover:bg-gray-300 dark:bg-gray-800 hover:dark:bg-gray-600/80 text-gray-600 dark:text-gray-400 transition-all duration-300 hover:shadow-lg"
              >
                <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="w-4 h-4" viewBox="0 0 576 512">
