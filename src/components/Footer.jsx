      ...
      <div className="mx-auto w-full max-w-screen-xl px-6 py-3 lg:py-2">
        <div className="sm:flex sm:items-end sm:justify-between">
          ...
          <div onClick={scrollUp} className="not-show-pop backtop relative group w-20 sm:w-24 flex items-start justify-start mb-2 sm:mb-0 rtl:space-x-reverse">
            ...
            <img src={theme === "dark" ? logo : blackLogo} className="w-full" alt="Logo" />
          </div>

          <div className="not-show-bottom flex flex-wrap items-center justify-start text-sm font-medium mb-1 text-gray-600 dark:text-gray-300 gap-4 md:gap-6">

            <Link onClick={scrollUp} to={"/profile"} className="about-foot hover:text-yellow-400 border-b-2 hover:border-yellow-400 border-transparent transition-all ease-linear duration-[400ms] delay-75">About</Link>
        ...
        <hr className="not-show-pop my-2 sm:mx-auto border-gray-300 dark:border-gray-700" />

        <div className="sm:flex sm:items-center sm:justify-between py-0 md:py-2">
          <span className="not-show-top text-xs sm:text-sm sm:text-center text-gray-600 dark:text-gray-300">© 2024-25 <a href="https://chandanchaudhary-portfolio.netlify.app/" className="hover:underline">Chandan Chaudhary</a>. All Rights Reserved.
          </span>

          <div className="not-show-top flex mt-4 sm:justify-center items-center sm:mt-0 gap-1">
            <a href="https://www.linkedin.com/in/chandan--chaudhary/" target="_blank" className="text-gray-500 dark:text-gray-300 hover:text-amber-600 dark:hover:text-yellow-400 hover:scale-110 transition-all duration-500 ease-in-out">
            ...
            <a href="https://github.com/iamchandanchaudhary" target="_blank" className="text-gray-500 dark:text-gray-300 hover:text-amber-600 dark:hover:text-yellow-400 ms-5 hover:scale-110 transition-all duration-500 ease-in-out">
            ...
            <a href="https://www.instagram.com/_.chandan_chaudhary/?hl=en" target="_blank" className="text-gray-500 dark:text-gray-300 hover:text-amber-600 dark:hover:text-yellow-400 ms-5 hover:scale-110 transition-all duration-500 ease-in-out">
              <svg className="w-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
            ...
            <a href="mailto:chandanchaudhary533@gmail.com" target="_blank" className="text-gray-500 dark:text-gray-300 hover:text-amber-600 dark:hover:text-yellow-400 ms-5 hover:scale-110 transition-all duration-500 ease-in-out">
            ...
            <a href="https://www.youtube.com/@c2explains" target="_blank" className="text-gray-500 dark:text-gray-300 hover:text-amber-600 dark:hover:text-yellow-400 ms-5 hover:scale-110 transition-all duration-500 ease-in-out">
