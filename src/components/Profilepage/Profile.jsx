    ...
    return (
        <>
            <div className="home relative h-screen w-full flex flex-col items-center justify-center">
                ...
                <div className="w-[90vw] md:w-[70vw] mt-10 px-6 md:px-10 pt-8 pb-4 flex justify-center items-center bg-gradient-to-b from-black/50 to-transparent backdrop-blur-sm rounded-md shadow-[0_0_15px_rgba(0,0,0,0.2)] border border-yellow-300/20">
                    <div className="w-full">
                        <h2 className="text-yellow-300 font-bold text-xl md:text-3xl">About me</h2>
                        <p className="mt-1 md:mt-2 text-[#fff] text-sm lg:text-base">I'm Chandan Chaudhary, a 18-year-old Indian <span className="text-yellow-300">Freelance</span> & <span className="text-yellow-300">MERN Stack developer</span>. I'm a weird guy who likes innovative things with web technologies.
                            ...
                            When my code is not working or futzing around the code, I study how to <span className="text-yellow-300">resolve</span> it.</p>
