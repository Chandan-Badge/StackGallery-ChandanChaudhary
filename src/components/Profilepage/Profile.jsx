    ...
    return (
        <>
            <div className="home relative h-screen w-full flex flex-col items-center justify-center">
                ...
                <div className="w-[90vw] md:w-[70vw] mt-10 px-6 md:px-10 pt-8 pb-4 flex justify-center items-center bg-gradient-to-b from-white/60 to-white/30 dark:from-black/50 dark:to-transparent backdrop-blur-sm rounded-md shadow-[0_0_15px_rgba(0,0,0,0.08)] dark:shadow-[0_0_15px_rgba(0,0,0,0.2)] border border-amber-400/30 dark:border-yellow-300/20">
                    <div className="w-full">
                        <h2 className="text-amber-600 dark:text-yellow-300 font-bold text-xl md:text-3xl">About me</h2>
                        <p className="mt-1 md:mt-2 text-gray-700 dark:text-[#fff] text-sm lg:text-base">I'm Chandan Chaudhary, a 18-year-old Indian <span className="text-amber-600 dark:text-yellow-300">Freelance</span> & <span className="text-amber-600 dark:text-yellow-300">MERN Stack developer</span>. I'm a weird guy who likes innovative things with web technologies.
                            <br />I like to <span className="text-amber-600 dark:text-yellow-300">resolve</span> frontend & backend problems, <span className="text-amber-600 dark:text-yellow-300">create</span> smart user interface and <span className="text-amber-600 dark:text-yellow-300">imagine</span> useful interaction, developing rich <span className="text-amber-600 dark:text-yellow-300">web experiences</span> & <span className="text-amber-600 dark:text-yellow-300">web applications</span>.
                            When my code is not working or futzing around the code, I study how to <span className="text-amber-600 dark:text-yellow-300">resolve</span> it.</p>
                        ...
                        <table className="gap-4 lg:gap-10 mt-4">
                            <tr className="text-xs md:text-sm lg:text-base">
                                <td className="text-amber-600 dark:text-yellow-300 font-bold flex">Name:</td>
                                <td className="font-normal text-gray-600 dark:text-gray-300 pl-2 sm:pl-6">Chandan Chaudhary</td>
                            </tr>

                            <tr className="text-xs md:text-sm lg:text-base">
                                <td className="text-amber-600 dark:text-yellow-300 font-bold flex">Profile:</td>
                                <td className="font-normal text-gray-600 dark:text-gray-300 pl-2 sm:pl-6">Full Stack Developer & Freelancer</td>
                            </tr>

                            <tr className="text-xs md:text-sm lg:text-base">
                                <td className="text-amber-600 dark:text-yellow-300 font-bold flex">Domain:</td>
                                <td className="font-normal text-gray-600 dark:text-gray-300 pl-2 sm:pl-6">Software Developement</td>
                            </tr>

                            <tr className="text-xs md:text-sm lg:text-base">
                                <td className="text-amber-600 dark:text-yellow-300 font-bold flex">Education:</td>
                                <td className="font-normal text-gray-600 dark:text-gray-300 pl-2 sm:pl-6">Bachelor of Computer Applications</td>
                            </tr>
                            ...
                            <tr className="text-xs md:text-sm lg:text-base">
                                <td className="text-amber-600 dark:text-yellow-300 font-bold flex">Freelance:</td>
                                <td className="font-normal text-gray-600 dark:text-gray-300 pl-2 sm:pl-6">Available</td>
                            </tr>
                        ...
                        <ul className="flex flex-wrap gap-2 lg:gap-3 mt-4 md:mt-8 text-[#333] dark:text-[#fff]">
                            ...
                            <li className="overflow-x-visible relative w-10 md:w-16 h-12 md:h-[72px] overflow-y-clip group text-center flex items-center justify-center">
                                <div className="flex justify-center items-center w-8 md:w-12 h-8 md:h-12 rounded-full transition-all duration-150 absolute top-0 group-hover:origin-top text-white">
                                    <svg className="fill-gray-800 dark:fill-[#fff] group-hover:fill-[#246bc4]" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32"><path d="M32 24.795c-1.164.296-1.884.013-2.53-.957l-4.594-6.356-.664-.88-5.365 7.257c-.613.873-1.256 1.253-2.4.944l6.87-9.222-6.396-8.33c1.1-.214 1.86-.105 2.535.88l4.765 6.435 4.8-6.4c.615-.873 1.276-1.205 2.38-.883l-2.48 3.288-3.36 4.375c-.4.5-.345.842.023 1.325L32 24.795zM.008 15.427l.562-2.764C2.1 7.193 8.37 4.92 12.694 8.3c2.527 1.988 3.155 4.8 3.03 7.95H1.48c-.214 5.67 3.867 9.092 9.07 7.346 1.825-.613 2.9-2.042 3.438-3.83.273-.896.725-1.036 1.567-.78-.43 2.236-1.4 4.104-3.45 5.273-3.063 1.75-7.435 1.184-9.735-1.248C1 21.6.434 19.812.18 17.9c-.04-.316-.12-.617-.18-.92q.008-.776.008-1.552zm1.498-.38h12.872c-.084-4.1-2.637-7.012-6.126-7.037-3.83-.03-6.58 2.813-6.746 7.037z"/></svg>
                                </div>
                                <div className="absolute -bottom-10 left-1/2 text-[10px] md:text-xs text-center text-gray-700 dark:text-[#fff] whitespace-nowrap transition-all duration-300 ease-in-out transform -translate-x-1/2 group-hover:bottom-0">
                                    Express.js
                                </div>
                            ...
                            <li className="overflow-x-visible relative w-10 md:w-16 h-12 md:h-[72px] overflow-y-clip group text-center flex items-center justify-center">
                                <div className="flex justify-center items-center w-8 md:w-12 h-8 md:h-12 p-1 rounded-full transition-all duration-150 absolute top-0 group-hover:origin-top text-white">
                                    <svg xmlns="http://www.w3.org/2000/svg" className="fill-gray-800 dark:fill-[#fff] group-hover:fill-[#1689b0]" viewBox="0 0 448 512"><path d="M448 80l0 48c0 44.2-100.3 80-224 80S0 172.2 0 128L0 80C0 35.8 100.3 0 224 0S448 35.8 448 80zM393.2 214.7c20.8-7.4 39.9-16.9 54.8-28.6L448 288c0 44.2-100.3 80-224 80S0 332.2 0 288L0 186.1c14.9 11.8 34 21.2 54.8 28.6C99.7 230.7 159.5 240 224 240s124.3-9.3 169.2-25.3zM0 346.1c14.9 11.8 34 21.2 54.8 28.6C99.7 390.7 159.5 400 224 400s124.3-9.3 169.2-25.3c20.8-7.4 39.9-16.9 54.8-28.6l0 85.9c0 44.2-100.3 80-224 80S0 476.2 0 432l0-85.9z"/></svg>
                                </div>
                                <div className="absolute -bottom-10 left-1/2 text-[10px] md:text-xs text-center text-gray-700 dark:text-[#fff] whitespace-nowrap transition-all duration-300 ease-in-out transform -translate-x-1/2 group-hover:bottom-0">
                                    Database
                                </div>
                            ...
                            <li className="overflow-x-visible relative w-10 md:w-16 h-12 md:h-[72px] overflow-y-clip group text-center flex items-center justify-center">
                                <div className="flex justify-center items-center w-8 md:w-12 h-8 md:h-12 rounded-full transition-all duration-150 absolute top-0 group-hover:origin-top text-white">
                                  <svg xmlns="http://www.w3.org/2000/svg" className="w-max fill-gray-800 dark:fill-[#fff] group-hover:fill-[#ffcc3b]" viewBox="0 0 448 512"><path d="M439.8 200.5c-7.7-30.9-22.3-54.2-53.4-54.2h-40.1v47.4c0 36.8-31.2 67.8-66.8 67.8H172.7c-29.2 0-53.4 25-53.4 54.3v101.8c0 29 25.2 46 53.4 54.3 33.8 9.9 66.3 11.7 106.8 0 26.9-7.8 53.4-23.5 53.4-54.3v-40.7H226.2v-13.6h160.2c31.1 0 42.6-21.7 53.4-54.2 11.2-33.5 10.7-65.7 0-108.6zM286.2 404c11.1 0 20.1 9.1 20.1 20.3 0 11.3-9 20.4-20.1 20.4-11 0-20.1-9.2-20.1-20.4 .1-11.3 9.1-20.3 20.1-20.3zM167.8 248.1h106.8c29.7 0 53.4-24.5 53.4-54.3V91.9c0-29-24.4-50.7-53.4-55.6-35.8-5.9-74.7-5.6-106.8 .1-45.2 8-53.4 24.7-53.4 55.6v40.7h106.9v13.6h-147c-31.1 0-58.3 18.7-66.8 54.2-9.8 40.7-10.2 66.1 0 108.6 7.6 31.6 25.7 54.2 56.8 54.2H101v-48.8c0-35.3 30.5-66.4 66.8-66.4zm-6.7-142.6c-11.1 0-20.1-9.1-20.1-20.3 .1-11.3 9-20.4 20.1-20.4 11 0 20.1 9.2 20.1 20.4s-9 20.3-20.1 20.3z"/></svg>
                                </div>
                                <div className="absolute -bottom-10 left-1/2 text-[10px] md:text-xs text-center text-gray-700 dark:text-[#fff] whitespace-nowrap transition-all duration-300 ease-in-out transform -translate-x-1/2 group-hover:bottom-0">
                                  Python
                                </div>
                    ...
                    <div className="w-[60%] relative hidden xl:flex items-center justify-center">
